...
class TemplateFieldViewData: ObservableObject, Identifiable {
  ...
  init(name: String, kind: String, defaultValue: String, order: Int16, options: [String]? = nil) {
    self.name = name
    self.kind = kind
    ...
    if kind == "checkbox" || kind == "date" || kind == "email" || kind == "phone_number" || kind == "rich_text" || kind == "title" || kind == "url" || kind == "multi_select" || kind == "select" || kind == "status" {
