...
struct TemplateNavigatorView: View {
    ...
    @State private var selectedDatabaseID: String? = nil
                        ...
                        ForEach(searchResults) { result in
                            ...
                            case .database(let database):
                                DatabaseListItemView(database: database)
                                    .background(selectedDatabaseID == database.id ? Color.accentColor : Color.clear)
                                    .onTapGesture {
                                        self.selectedDatabaseID = database.id
